    ...
    return (
        ...
        <div className = 'Cgfilter'>
            ...
            <ul>
                    ...
                    <Link className = 'lined'  to = '?cg=Burger'>Burger</Link>
                    <Link className = 'lined'  to = '?cg=Pizza'>Pizza</Link>
                    <Link className = 'lined'  to = '?cg=Meal'>Meal</Link>
                    <Link className = 'lined' to = '?cg=Coffee'>Coffee</Link>
                    <Link to = '?cg=Cookie' className = 'lined'>Cookie</Link>
            </ul>
            </div>
        </div>
