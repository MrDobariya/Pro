...
const Contactus = () => {
    ...
    const handlesubmit = () =>{
        window.open(`mailto:atlanta@gmail.com?subject=Sample&body=${body}`)
    }
    return (
        ...
        <div className="headerContact">
            <Image className="imageContact" src='https://images.unsplash.com/photo-1577563908411-5077b6dc7624?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80'  alt="contactImage" objectFit="cover"/>
            <div className="text">
                <h2>Contact</h2>  
            </div>
            ...
            <div className="showAdrss">
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3> Address</h3>
                        <p>Atlanta shop, VIP road, surat</p>
                    </div>
                </div>
                    <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Lets Talk</h3>
                        <p className="infoCtn">+91 98765 43210</p>
                    </div>
                </div>
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Sale Support</h3>
                        <p className="infoCtn">contect@altanta.com</p>
                    </div>
                </div>
            </div>
        </div>
